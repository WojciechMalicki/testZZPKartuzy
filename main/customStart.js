...
function customCreate_Player(playerId) {
  Players[playerId]={
    ...
    id:playerId,
    wood:Number(document.getElementById('Wood').value),
    stone:Number(document.getElementById('Stone').value),
    people:people,
    gold:Number(document.getElementById('Gold').value),
    food:Number(document.getElementById('Food').value),
    iron:Number(document.getElementById('Iron').value),
    men:Number(document.getElementById('Men').value),
    soldier:Number(document.getElementById('Solidier').value),
    farm:Number(document.getElementById('Farm').value),
    forge:Number(document.getElementById('Forge').value),
    house:Number(document.getElementById('House').value),
    totem:Number(document.getElementById('Totem').value),
    barracks:Number(document.getElementById('Barracks').value),
		fort:Number(document.getElementById('Fort').value),
