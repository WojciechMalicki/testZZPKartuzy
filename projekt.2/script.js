...
function start()
{
    	...
    	if(player_number==4)
    	{
	        if(turn==2)
	        {
	            ...
	            document.getElementById("green").innerHTML += '<input type="button" value="zbuduj budynek" onclick="building_menu(Player1)"><br/><br/>';
	            document.getElementById("green").innerHTML += '<input type="button" value="zakończ ture" onclick="end_of_turn(Player1)"><br/><br/>';
	        ...
	        else if(turn==3)
	        {
	            ...
	            document.getElementById("green").innerHTML += '<input type="button" value="zbuduj budynek" onclick="building_menu(Player2)"><br/><br/>';
	            document.getElementById("green").innerHTML += '<input type="button" value="zakończ ture" onclick="end_of_turn(Player2)"><br/><br/>';
	        ...
	        else if(turn==4)
	        {
	            ...
	            document.getElementById("green").innerHTML += '<input type="button" value="zbuduj budynek" onclick="building_menu(Player3)"><br/><br/>';
	            document.getElementById("green").innerHTML += '<input type="button" value="zakończ ture" onclick="end_of_turn(Player3)"><br/><br/>';
	        ...
	        else
	        {
	            ...
	            document.getElementById("green").innerHTML += '<input type="button" value="zbuduj budynek" onclick="building_menu(Player0)"><br/><br/>';
	            document.getElementById("green").innerHTML += '<input type="button" value="zakończ ture" onclick="end_of_turn(Player0)"><br/><br/>';
...
function building_menu(player)
{
	...
	JSON.stringify(player.number);
 	   ...
 	   {
 	   		posibilities += '<input type="button" class="build_farm" value="Zbuduj farme" onclick="build(0,Player'+obj+')" style="float:left; margin-left: 20px;">';
 	   }
       if(player.wood>=forge.cost.wood && player.food>=forge.cost.food && player.men>= forge.cost.men && player.gold >= forge.cost.gold && player.iron>=forge.cost.iron && player.stone >= forge.cost.stone)
 	   {
 	   		posibilities += '<input type="button" class="build_forge" value="Zbuduj kuźnie" onclick="build(1,Player'+obj+')" style="margin-right:20px;">';
 	   }
 	   ...
 	   {
 	   		posibilities += '<input type="button" class="build_house" value="Zbuduj dom" onclick="build(2,Player'+obj+')" style="float: right; margin-right:20px;"><br/><br/><br/>';
 	   }
 	   ...
 	   {
 	   		posibilities += '<input type="button" class="build_totem" value="Zbuduj totem" onclick="build(3,Player'+obj+')" style="margin:auto;"><br/><br/><br/>';
 	   }
 	   posibilities += '<input type="button" value="zakończ ture" onclick="end_of_turn(Player'+obj+')"><br/><br/>';
