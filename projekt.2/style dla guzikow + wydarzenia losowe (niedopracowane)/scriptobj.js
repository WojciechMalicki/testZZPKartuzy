...
function building_menu()
{
	...
	JSON.stringify(Players[turn].number);
       ...
       if(Players[turn].wood>=forge.cost.wood && Players[turn].food>=forge.cost.food && Players[turn].men>= forge.cost.men && Players[turn].gold >= forge.cost.gold && Players[turn].iron>=forge.cost.iron && Players[turn].stone >= forge.cost.stone)
 	   {
 	   		posibilities += '<input type="button" class="build" value="Zbuduj kuźnie" onclick="build(1)" style="margin-right:20px;"><input type="button" id="Opis2" value="Opis" onclick="description(1)"> ';
 	   }
 	   ...
 	   {
 	   		posibilities += '<input type="button" class="build" value="Zbuduj dom" onclick="build(2)" style="float: right; margin-right:20px;"> <input type="button" id="Opis2" value="Opis" onclick="description(2)"> <br/><br/><br/>';
 	   }
 	   ...
 	   {
 	   		posibilities += '<input type="button" class="build" value="Zbuduj totem" onclick="build(3)" style="margin:auto;"><input type="button" id="Opis4" value="Opis" onclick="description(3)"> <br/><br/><br/>';
 	   }
